...
MESSAGES = {  # step - short name
    ...
    'main_addcard_name': {
        ...
        'length': StaticMessage('Слишком длинное название (не более 32 символов)', 'Name is too long'),
        'format': StaticMessage('Используйте русские, английские буквы и цифры', 'Wrong format of name'),
        'ok': StaticMessage('$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$\nПридумайте защитный код (до 16 символов)\n' +
                            TEMPLATES['code'], 'Name format is OK')
    },
    'main_addcard_num': {
        ...
        'ok': StaticMessage('$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$\nВведите дату окончания срока действия карты\n' +
                            TEMPLATES['date'], 'Num format is OK'),
    },
    'main_addcard_code': {
    ...
    'main_addcard_date': {
        'length': StaticMessage('Пожалуйста, введите 4 или 6 цифр даты (ммгггг или ммгг)', 'Length error'),
    ...
    'main_delete': {
        'confirm_delete': StaticMessage('Выбрана карта *{}*\nВы уверены, что хотите удалить ее из базы? Отмена '
                                        'невозможна!'),
        'yes': StaticMessage('Выбрана карта *{}*\nКарта удалена'),
        'no': StaticMessage('Выбрана карта *{}*\nУдаление отменено')
    },
    'main_watchcard': {
        'decode': StaticMessage('Произошла ошибка при декодировании.\nВозможно, защитный код введен неправильно. '
                                'Попробуйте еще раз', 'Decode error'),
        'digit': StaticMessage('Произошла ошибка.\nВозможно, защитный код введен неправильно. Попробуйте еще раз',
                               'Not digit in result error'),
        'ok': StaticMessage('Защитный код принят. Данное сообщение исчезнет через 5 секунд.\n{}\n{}', 'Decode is OK'),
