...
from bot.markups.markups import canc_but
from bot.utils.crypto.m3crypto import decrypt, encrypt
...
class CardData:
    ...
    subjFunc = {
        ...
        'reset': {'date': resetDate, 'cvc': resetCvc, 'pin': resetPin},
        'addNum': {'date': addNumDate, 'cvc': addNumCvc, 'pin': addNumPin},
    }
